...
class HarvestRepositoryTest {
    ...
    private List<Harvest> findHarvests(UUID id, LocalDateTime start, LocalDateTime end) {
    ...
    void findAllByHarvesterIdAndDate_ShowAll_WhenDatesAreNull() {
        List<Harvest> results = findHarvests(harvesterId, null, null);
    ...
    void findAllByHarvesterIdAndDate_OnlyStartDate() {
        ...
        List<Harvest> results = findHarvests(harvesterId, start, null);
    ...
    void findAllByHarvesterIdAndDate_OnlyEndDate() {
        ...
        List<Harvest> results = findHarvests(harvesterId, null, end);
        assertEquals(1, results.size());
    ...
    void findAllByHarvesterIdAndDate_PassAllDateFilter() {
        ...
        List<Harvest> results = findHarvests(harvesterId, start, end);
        assertEquals(2, results.size());
    }
}